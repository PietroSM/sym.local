 ...
 */
final class Version20250110104012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE imagen (id INT AUTO_INCREMENT NOT NULL, categoria_id INT NOT NULL, nombre VARCHAR(100) DEFAULT NULL, descripcion VARCHAR(100) DEFAULT NULL, num_visualizaviones INT DEFAULT NULL, num_like INT DEFAULT NULL, num_download INT DEFAULT NULL, password VARCHAR(100) DEFAULT NULL, INDEX IDX_8319D2B33397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
